...
- **养成党** — 给你的 AI 打工仔升职加薪、练技能、攒金币，看着实习生一路升到组长，比养电子宠物还上头
- **装修狂魔** — 像 The Sims 一样摆工位、换地板、放绿植和咖啡机，打造你心目中的理想办公室
- **摸鱼观察家** — 谁在认真写代码？谁在喝咖啡发呆？谁下班趴桌子睡着了？比看监控还有意思
- **直播 / 录屏** — 开着像素办公室当背景，观众看 AI 打工比看纯终端有趣一百倍
- **多 Agent 用户** — 同时跑好几个 Agent？办公室一眼看清谁在干什么，不用再翻终端窗口
